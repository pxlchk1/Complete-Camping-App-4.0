    ...
    >
      <SafeAreaView className="flex-1 bg-parchment" edges={['bottom']}>
        ...
        <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
          ...
          >
            Nature has a way of steadying us. Even a simple night outside can reset your
            brain in the best way. I built this app to take some of the stress out of
            planning, packing, and getting started, so more people can experience that
            kind of calm.
          </Text>
          <Text
            className="text-base mb-2 leading-6"
          ...
          >
            I hope it helps. And if it does, I&apos;d be really grateful if you&apos;d
            leave a review or share the app with a friend.
          </Text>
          <Text
          ...
          <View className="mb-8 space-y-3">
            ...
            <View className="mb-3">
              ...
              <Pressable
                onPress={() =>
                  handleLinkPress('https://www.instagram.com/tent.and.lantern')
                }
              >
                <Text
                  className="text-base underline"
            ...
            <View className="mb-3">
              ...
              <Pressable
                onPress={() => handleLinkPress('mailto:info@tentandlantern.com')}
              >
                <Text
                  className="text-base underline"
                  style={{ fontFamily: 'SourceSans3_400Regular', color: '#2563eb' }}
