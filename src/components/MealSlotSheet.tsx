...
export default function MealSlotSheet({
  ...
  // State
  const [activeSection, setActiveSection] = useState<'suggest' | 'recipes' | 'custom'>(
    'suggest',
  );
            ...
            <View className="px-5 pt-6 pb-4" style={{ backgroundColor: DEEP_FOREST }}>
              <View className="flex-row items-center justify-between">
                <View className="flex-row items-center flex-1">
                  <Ionicons name={CATEGORY_ICONS[category]} size={24} color={PARCHMENT} />
                  <Text
                    className="ml-3"
                    style={{
                        ...
                        <View className="flex-row items-start">
                          ...
                          >
                            <Ionicons
                              ...
                              size={16}
                              color={
                                suggestion.type === 'recipe' ? EARTH_GREEN : GRANITE_GOLD
                              }
                            />
                          </View>
                      ...
                      >
                        <Text
                          style={{
                            ...
                            fontSize: 12,
                            color:
                              selectedFilter === chip.key ? PARCHMENT : TEXT_SECONDARY,
                          }}
                        >
                          {chip.label}
                        </Text>
