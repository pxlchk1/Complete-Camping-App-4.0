    ...
    >
      ...
      <View className="flex-row items-start justify-between mb-3">
        <View className="flex-1 mr-3">
          <Text
            className="text-lg font-semibold text-forest mb-1"
          ...
          <View className="flex-row items-center">
            ...
            <Text
              className="text-riverRock text-sm font-medium ml-1"
      ...
      <View className="flex-row items-center mb-3">
        ...
        <Text
          className="text-earthGreen text-sm ml-1"
      ...
      {/* Address */}
      <Text
        className="text-earthGreen text-sm leading-5"
        style={{ fontFamily: 'SourceSans3_400Regular' }}
        numberOfLines={2}
      >
        {park.address}
