  ...
  const filteredSuggestions = useMemo(() => {
    ...
    return suggestions.filter((suggestion) => {
      ...
      if (selectedFilter === 'cold-weather') {
        return (
          suggestion.tags?.includes('cold-weather') ||
          suggestion.tags?.includes('warming')
        );
      }
                  ...
                  >
                    <Text
                      style={{
                        fontFamily: 'SourceSans3_600SemiBold',
                        fontSize: 12,
                        color: selectedFilter === chip.key ? PARCHMENT : EARTH_GREEN,
                      }}
                    >
                      {chip.label}
                    </Text>
                                ...
                                <Ionicons
                                  name={
                                    suggestion.complexity === 'easy'
                                      ? 'flash-outline'
                                      : suggestion.complexity === 'moderate'
                                        ? 'restaurant-outline'
                                        : 'flame-outline'
                                  }
                                  size={12}
