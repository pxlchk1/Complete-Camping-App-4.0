    ...
    >
      ...
      <View className="flex-row items-start justify-between mb-2">
        <View className="flex-1 mr-2">
          <Text
            className="text-base text-forest-800 mb-1"
      ...
      {/* Review Title */}
      <Text
        className="text-sm text-forest-700 mb-2"
        style={{ fontFamily: 'SourceSans3_600SemiBold' }}
      >
        {review.title}
      </Text>
        ...
        <View className="flex-row items-center">
          {review.verifiedPurchase && (
            <>
              ...
              <Text
                className="text-xs text-green-600 ml-1 mr-3"
                style={{ fontFamily: 'SourceSans3_600SemiBold' }}
              >
                Verified
              </Text>
          ...
          <Text
            className="text-xs text-stone-600 ml-1"
            style={{ fontFamily: 'SourceSans3_400Regular' }}
          >
            {review.helpfulCount}
          </Text>
