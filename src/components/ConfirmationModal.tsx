...
export default function ConfirmationModal({
  ...
  return (
    <Modal visible={visible} transparent animationType="none" onRequestClose={onClose}>
      <View
        className="flex-1 bg-black/50 items-center justify-end px-4 pb-6"
        pointerEvents="auto"
      >
        <View className="w-full max-w-md bg-parchment rounded-3xl p-5 shadow-lg border border-parchmentDark">
          ...
          <View className="flex-row items-center justify-between mb-2">
            <View className="flex-row items-center">
              ...
              <Text
                className="text-lg font-semibold text-[#16492f]"
            ...
            <Pressable
              onPress={onClose}
              className="rounded-full p-1.5 bg-parchment active:bg-gray-200"
            >
          ...
          {message ? (
            <Text
              className="text-earthGreen mb-4"
          ...
          <View className="space-y-3">
            ...
            >
              <View className="flex-row items-center">
                ...
                <Text
                  className="text-parchment font-semibold text-base ml-1"
            ...
            >
              <View className="flex-row items-center">
                ...
                <Text
                  className="text-forest font-semibold text-base ml-1"
                  style={{ fontFamily: 'SourceSans3_600SemiBold' }}
                >
                  {secondary.label}
                </Text>
