...
const COOKING_FOOD: PackingTemplate = {
  ...
  items: [
    ...
    {
      name: 'Groceries from Meal Plan Shopping List',
...
const WINTER_CAMPING: PackingTemplate = {
  ...
  items: [
    ...
    {
      name: 'Cold-rated sleeping bag (0-20°F)',
      category: 'Shelter & Sleep',
      essential: true,
    },
    {
      name: 'Insulated sleeping pad (R4+)',
      category: 'Shelter & Sleep',
      essential: true,
    },
...
const PETS: PackingTemplate = {
  ...
  items: [
    ...
    {
      name: 'Dog sunscreen (for light-colored dogs)',
...
const FAMILY_CAMPING: PackingTemplate = {
  ...
  items: [
    ...
    {
      name: 'Sleeping pads/air mattresses',
      category: 'Shelter & Sleep',
      essential: true,
    },
    { name: 'Extra blankets', category: 'Shelter & Sleep', essential: false },
