...
const INITIAL_MEAL_LIBRARY: Omit<MealLibraryItem, 'id' | 'createdAt'>[] = [
  // BREAKFAST - No Cook
  {
    ...
    suitableFor: ['backpacking', 'car camping', 'RV'],
    tags: ['no-cook', 'prepare-ahead'],
  },
  {
    ...
    suitableFor: ['car camping', 'RV', 'glamping'],
    tags: ['no-cook', 'quick'],
  },
  {
  ...
  },
  {
    ...
    suitableFor: ['all'],
    tags: ['no-cook', 'protein', 'prepare-ahead'],
  },
  {
    ...
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['apples', 'bananas', 'almonds', 'walnuts'],
    suitableFor: ['backpacking', 'car camping'],
  ...
  },
  {
    ...
    suitableFor: ['car camping', 'RV'],
    tags: ['no-cook', 'prepare-ahead'],
  },
  {
    name: 'Cold Cereal with Milk',
    category: 'breakfast',
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['cereal', 'shelf-stable milk'],
    suitableFor: ['car camping', 'RV', 'glamping'],
    tags: ['no-cook', 'quick'],
  },
  {
    ...
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['granola bars', 'protein bars'],
    suitableFor: ['backpacking', 'bikepacking'],
    tags: ['no-cook', 'quick', 'portable'],
  },
  {
    name: 'Apples with Peanut Butter',
    category: 'breakfast',
    prepType: 'noCook',
    difficulty: 'easy',
  ...
  // BREAKFAST - Hot
  {
    name: 'Scrambled Eggs and Veggies',
    category: 'breakfast',
    prepType: 'campStove',
    difficulty: 'easy',
  ...
  {
    name: 'Egg and Cheese Burritos',
    category: 'breakfast',
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['eggs', 'tortillas', 'cheese', 'salsa'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['hot', 'filling'],
  },
  {
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['tortillas', 'eggs', 'cheese', 'sausage', 'salsa'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['hot', 'filling'],
  },
  {
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['hash browns', 'eggs', 'butter', 'salt', 'pepper'],
    suitableFor: ['car camping', 'RV'],
    tags: ['hot', 'hearty'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['oats', 'water', 'brown sugar', 'dried fruit', 'nuts'],
    suitableFor: ['backpacking', 'car camping'],
    tags: ['hot', 'healthy'],
  },
  {
    ...
    suitableFor: ['car camping', 'RV'],
    tags: ['hot', 'protein', 'classic'],
  },
  {
    name: 'Breakfast Skillet with Beans and Cheese',
    category: 'breakfast',
    prepType: 'campStove',
    difficulty: 'moderate',
    ingredients: ['potatoes', 'eggs', 'black beans', 'cheese', 'salsa'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['hot', 'hearty'],
  },
  {
    name: 'Camp Cornbread Muffins',
    category: 'breakfast',
    prepType: 'campfire',
    difficulty: 'moderate',
    ingredients: ['cornbread mix', 'eggs', 'milk', 'butter'],
    suitableFor: ['car camping'],
    tags: ['hot', 'baked'],
  },
  ...
  },
  {
    ...
    prepType: 'cold',
    difficulty: 'easy',
    ingredients: ['pasta', 'italian dressing', 'veggies', 'cheese'],
    suitableFor: ['car camping', 'RV'],
    tags: ['prepare-ahead', 'vegetarian'],
  },
  {
    ...
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['hummus', 'carrots', 'celery', 'bell peppers', 'pita'],
    suitableFor: ['car camping', 'backpacking'],
    tags: ['no-cook', 'vegetarian', 'healthy'],
  },
  {
    ...
    prepType: 'cold',
    difficulty: 'easy',
    ingredients: ['noodles', 'peanut butter', 'soy sauce', 'sesame oil', 'veggies'],
    suitableFor: ['car camping'],
    tags: ['prepare-ahead', 'vegetarian'],
  },
  {
    name: 'Charcuterie Lunch',
    category: 'lunch',
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['salami', 'cheese', 'crackers', 'grapes', 'nuts'],
    suitableFor: ['car camping', 'glamping'],
    tags: ['no-cook', 'variety'],
  },
  {
    ...
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['mozzarella', 'tomatoes', 'basil', 'olive oil', 'balsamic', 'bread'],
    suitableFor: ['car camping', 'RV'],
    tags: ['no-cook', 'fresh'],
  },
  {
  ...
  },
  {
    ...
    prepType: 'cold',
    difficulty: 'easy',
    ingredients: ['couscous', 'veggies', 'feta', 'lemon', 'olive oil'],
    suitableFor: ['car camping'],
    tags: ['prepare-ahead', 'vegetarian'],
  },
  {
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['ramen noodles', 'eggs', 'scallions', 'veggies'],
    suitableFor: ['backpacking', 'car camping'],
    tags: ['hot', 'quick'],
  },
  {
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['canned tomato soup', 'bread', 'cheese', 'butter'],
    suitableFor: ['car camping', 'RV'],
    tags: ['hot', 'comfort'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['mac and cheese box', 'milk', 'butter'],
    suitableFor: ['car camping', 'RV'],
    tags: ['hot', 'kid-friendly'],
  },
  {
    name: 'Hot Dogs',
    category: 'lunch',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['hot dogs', 'buns', 'ketchup', 'mustard'],
    suitableFor: ['car camping'],
    tags: ['hot', 'quick', 'kid-friendly'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['rice', 'beans', 'cheese', 'salsa', 'sour cream'],
    suitableFor: ['car camping', 'RV'],
    tags: ['hot', 'filling'],
  },
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['ground beef', 'macaroni', 'tomatoes', 'chili powder', 'cheese'],
    suitableFor: ['car camping'],
    tags: ['one-pot', 'filling'],
  },
  {
    name: 'One Pot Pasta',
    category: 'dinner',
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['pasta', 'tomato sauce', 'garlic', 'italian seasoning'],
    suitableFor: ['car camping', 'backpacking'],
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['sausage', 'bell peppers', 'onions', 'potatoes'],
    suitableFor: ['car camping', 'overlanding'],
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'moderate',
    ingredients: ['mixed veggies', 'soy sauce', 'garlic', 'ginger', 'rice'],
    suitableFor: ['car camping', 'RV'],
    tags: ['one-pot', 'vegetarian', 'healthy'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'moderate',
    ingredients: ['curry paste', 'coconut milk', 'veggies', 'rice'],
    suitableFor: ['car camping', 'RV'],
    tags: ['one-pot', 'flavorful'],
  },
  {
    name: 'Alfredo Pasta with Veggies',
    category: 'dinner',
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['pasta', 'alfredo sauce', 'broccoli', 'parmesan'],
    suitableFor: ['car camping', 'RV'],
    tags: ['one-pot', 'creamy'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'moderate',
    ingredients: ['chicken', 'rice', 'broth', 'veggies', 'seasonings'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['one-pot', 'protein'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'moderate',
    ingredients: ['sausage', 'chicken', 'rice', 'peppers', 'cajun seasoning'],
    suitableFor: ['car camping'],
    tags: ['one-pot', 'spicy'],
  },
  {
    ...
    suitableFor: ['car camping', 'winter camping'],
    tags: ['one-pot', 'hearty'],
  },

  // DINNER - Foil Packets
  {
    name: 'Chicken Fajita Packets',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['chicken', 'bell peppers', 'onions', 'fajita seasoning', 'tortillas'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['foil-packet', 'protein'],
  },
  {
    name: 'Sausage, Peppers, and Potatoes',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['sausage', 'bell peppers', 'potatoes', 'onions', 'olive oil'],
    suitableFor: ['car camping'],
    tags: ['foil-packet', 'filling'],
  },
  {
    ...
    suitableFor: ['car camping', 'glamping'],
    tags: ['foil-packet', 'healthy'],
  },
  {
    name: 'Shrimp Boil Packets',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'moderate',
    ingredients: ['shrimp', 'corn', 'potatoes', 'sausage', 'old bay'],
    suitableFor: ['car camping'],
    tags: ['foil-packet', 'seafood'],
  },
  {
    name: 'BBQ Tofu Packets',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['tofu', 'BBQ sauce', 'veggies', 'foil'],
    suitableFor: ['car camping'],
    tags: ['foil-packet', 'vegetarian'],
  },
  {
    name: 'Sweet Potato and Black Bean Packet',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['sweet potatoes', 'black beans', 'corn', 'cumin', 'lime'],
    suitableFor: ['car camping'],
    tags: ['foil-packet', 'vegetarian'],
  },
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['flatbread', 'tomato sauce', 'cheese', 'toppings'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['quick', 'customizable'],
  },
  {
    name: 'Brats with Peppers',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['bratwurst', 'peppers', 'onions', 'buns'],
    suitableFor: ['car camping'],
    tags: ['campfire', 'protein'],
  },
  {
    name: 'Beef or Veggie Kabobs',
    category: 'dinner',
    prepType: 'campfire',
    difficulty: 'moderate',
    ingredients: ['beef or veggies', 'bell peppers', 'onions', 'marinade', 'skewers'],
    suitableFor: ['car camping'],
    tags: ['campfire', 'protein'],
  },
  {
    name: 'Cast Iron Burgers',
    category: 'dinner',
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['ground beef', 'buns', 'cheese', 'toppings'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['classic', 'protein'],
  },
  {
    name: 'Pan Fried Gnocchi',
    category: 'dinner',
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['gnocchi', 'butter', 'garlic', 'parmesan'],
    suitableFor: ['car camping', 'RV'],
  ...
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'moderate',
    ingredients: ['rice', 'eggs', 'veggies', 'soy sauce', 'sesame oil'],
    suitableFor: ['car camping', 'overlanding'],
    tags: ['versatile'],
  },
  {
  ...
  },
  {
    ...
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['potatoes', 'butter', 'sour cream', 'cheese', 'bacon bits'],
    suitableFor: ['car camping'],
    tags: ['campfire', 'filling'],
  },
  ...
  {
    name: 'Crackers and Salami',
    category: 'snack',
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['crackers', 'salami'],
    suitableFor: ['car camping', 'backpacking'],
    tags: ['no-cook', 'protein'],
  },
  {
  ...
  },
  {
    ...
    suitableFor: ['backpacking', 'car camping'],
    tags: ['no-cook', 'crunchy', 'healthy'],
  },
  {
    name: 'Popcorn Over the Fire',
    category: 'snack',
    prepType: 'campfire',
    difficulty: 'easy',
  ...
  {
    name: 'Pita Chips and Hummus',
    category: 'snack',
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['pita chips', 'hummus'],
    suitableFor: ['car camping'],
  ...
  },
  {
    ...
    suitableFor: ['all'],
    tags: ['no-cook', 'energy', 'prepare-ahead'],
  },
  {
    name: 'Fruit Leather',
    category: 'snack',
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['fruit leather'],
    suitableFor: ['all'],
    tags: ['no-cook', 'sweet', 'portable'],
  },
  {
    name: 'Dried Mango',
    category: 'snack',
  ...
  },
  {
    ...
    prepType: 'noCook',
    difficulty: 'easy',
    ingredients: ['banana chips'],
    suitableFor: ['all'],
    tags: ['no-cook', 'crunchy'],
  },
  {
    name: "S'mores",
    category: 'snack',
  ...
  },
  {
    ...
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['bananas', 'chocolate chips', 'marshmallows'],
    suitableFor: ['car camping'],
    tags: ['campfire', 'sweet', 'fun'],
  },
  {
    name: 'Roasted Apples with Cinnamon',
    category: 'snack',
    prepType: 'campfire',
    difficulty: 'easy',
    ingredients: ['apples', 'cinnamon', 'brown sugar'],
    suitableFor: ['car camping'],
    tags: ['campfire', 'sweet', 'healthy'],
  },
  {
    ...
    prepType: 'campStove',
    difficulty: 'easy',
    ingredients: ['hot cocoa mix', 'water', 'marshmallows'],
    suitableFor: ['car camping', 'winter camping'],
    tags: ['hot', 'sweet', 'cozy'],
  },
];
    ...
    (set, get) => ({
      ...
      initializeMealLibrary: () => {
        ...
        if (mealLibrary.length === 0) {
          const populatedLibrary: MealLibraryItem[] = INITIAL_MEAL_LIBRARY.map(
            (meal, index) => ({
              ...meal,
...
export const useInitializeMealLibrary = () =>
  useMealStore((s) => s.initializeMealLibrary);
