...
export interface ModuleProgress {
  ...
  completedAt?: string;
  steps: {
    [stepId: string]: { stepId: string; status: StepStatus; completedAt?: string };
  };
}
...
const DEFAULT_MODULES: LearningModule[] = [
  ...
  LNT_EXPANDED_MODULE as LearningModule,
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Choose one or two nights. Avoid extreme heat or deep cold. Check sunrise and sunset so you have plenty of daylight for setup.',
        duration: 2,
      },
      {
        id: 'first-3',
        ...
        type: 'article',
        content:
          'Pick a simple, drive up site with bathrooms. Check for potable water, fire rules, and quiet hours. Look at photos posted by campers.',
        duration: 2,
      },
      {
        id: 'first-4',
        ...
        type: 'article',
        content:
          'Keep it easy. Sandwiches, pasta, oatmeal. Have a backup if it rains. Bring snacks that do not require cooking.',
        duration: 2,
      },
      {
        id: 'first-5',
        ...
        type: 'article',
        content:
          'Check your gear. Test your stove. Make sure you have the right sleeping bag. Charge your lights.',
        duration: 2,
      },
      {
        id: 'first-quiz',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'A two person tent fits two people only if nobody moves. Choose a larger size than you think you need.',
        duration: 2,
      },
      {
        id: 'tent-3',
        ...
        type: 'article',
        content:
          'Most beginners need a three season tent. It handles spring, summer, and fall weather.',
        duration: 2,
      },
      {
        id: 'tent-4',
        ...
        type: 'article',
        content:
          'More doors mean easier exits at night. Vestibules give you covered storage.',
        duration: 2,
      },
      {
        id: 'tent-5',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Assemble the poles. Slide them into the sleeves or clips. The tent will lift as you go.',
        duration: 2,
      },
      {
        id: 'pitch-5',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'The pad matters more than the bag. Look at R value. Higher numbers mean warmer nights.',
        duration: 2,
      },
      {
        id: 'sleep-3',
        ...
        type: 'article',
        content:
          'Choose a temperature rating about ten degrees colder than the lowest expected temp.',
        duration: 2,
      },
      {
        id: 'sleep-4',
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Eat something warm before bed. Add a fleece under your hips. Keep your bag lofted.',
        duration: 2,
      },
      {
        id: 'sleep-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Weather is a mood setter. You can be ready for almost anything with a few simple habits.',
        duration: 2,
      },
      {
        id: 'warm-2',
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Have a dry place for gear. Keep clothes in bags. Vent your tent to avoid condensation.',
        duration: 2,
      },
      {
        id: 'warm-4',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'You do not need to be a medic. A few simple steps help in most situations.',
        duration: 2,
      },
      {
        id: 'aid-2',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'A multi day trip asks more from you than a casual overnight. You are thinking about distance, weather windows, water sources, food weight, and how everyone in your group will handle the terrain. Planning well turns a long trip into a calm, steady experience instead of a scramble.',
        duration: 2,
      },
      {
        id: 'multi-2',
        ...
        type: 'article',
        content:
          'Start by choosing the total number of nights, then pick a route that fits your slowest hiker. Beginners often overestimate their pace. A good goal is six to eight miles per day on normal terrain. Shorter days give you time to settle into camp before dark.',
        duration: 3,
      },
      {
        id: 'multi-3',
        ...
        type: 'article',
        content:
          'Study maps, ranger reports, recent trip logs, and trail closures. Look for river crossings, steep climbs, exposed ridges, or long dry segments. Make notes about where you can camp and where water is available.',
        duration: 3,
      },
      {
        id: 'multi-4',
        ...
        type: 'article',
        content:
          'Break each day into sections. Start time. Expected pace. Meal breaks. Landmarks. Camp setup time. Build in buffer for weather and fatigue.',
        duration: 3,
      },
      {
        id: 'multi-5',
        ...
        type: 'article',
        content:
          'Share your route, group names, car plate numbers, and your expected return day with someone at home. Set simple rules for group communication on the trail. For example, no one hikes alone.',
        duration: 2,
      },
      {
        id: 'multi-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Terrain shapes the whole experience. A three mile hike on flat forest trails is not the same as a three mile hike with steep climbs or loose rock. Learning how to read and interpret terrain helps you choose the right route for your group.',
        duration: 2,
      },
      {
        id: 'terrain-2',
        ...
        type: 'article',
        content:
          'The number that surprises most new hikers is total elevation gain. Five hundred feet of climbing feels noticeable. One thousand feet starts to test people. Breaks help, but the best tool is pacing.',
        duration: 3,
      },
      {
        id: 'terrain-3',
        ...
        type: 'article',
        content:
          'Trails can be smooth dirt, packed gravel, loose rock, sand, mud, or uneven roots. Each surface requires a different walking rhythm. Wet roots are slick. Sand drains energy. Scree fields demand slow, careful steps.',
        duration: 3,
      },
      {
        id: 'terrain-4',
        ...
        type: 'article',
        content:
          'Exposure means how much of the trail leaves you out in the open. It may mean steep drops near the trail edge or long stretches without tree cover. Exposure is not a problem if you know it is coming and plan breaks.',
        duration: 3,
      },
      {
        id: 'terrain-5',
        ...
        type: 'article',
        content:
          'Some trails have ladders, boulders, narrow ledges, or water crossings. These require group communication and patient movement. Leaders guide one person at a time through these areas.',
        duration: 2,
      },
      {
        id: 'terrain-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Weather decides the mood of your trip. Knowing how to read signs in the sky helps you avoid surprises and make safe decisions.',
        duration: 2,
      },
      {
        id: 'weather-2',
        ...
        type: 'article',
        content:
          'Flat grey clouds usually bring steady rain. Tall towering clouds may signal storms. A green tint in storm clouds can indicate hail. A glowing red sunrise often hints at incoming weather.',
        duration: 3,
      },
      {
        id: 'weather-3',
        ...
        type: 'article',
        content:
          'Wind that suddenly changes direction or speed can mean a weather shift. Strong gusts before a storm are common.',
        duration: 2,
      },
      {
        id: 'weather-4',
        ...
        type: 'article',
        content:
          'Quick cooling in late afternoon can mean a storm approaching. Carry layers where they are easy to reach.',
        duration: 2,
      },
      {
        id: 'weather-5',
        ...
        type: 'article',
        content:
          'Rangers and local hikers often know how weather behaves in a specific valley or ridge. Their knowledge is gold.',
        duration: 2,
      },
      {
        id: 'weather-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'A good campsite keeps you comfortable, dry, and organized. A bad one keeps you awake all night.',
        duration: 2,
      },
      {
        id: 'camp-2',
        ...
        type: 'article',
        content:
          'Choose high ground that drains well. Stay clear of narrow valleys and dry creek beds. Avoid overhead hazards like dead limbs.',
        duration: 2,
      },
      {
        id: 'camp-3',
        ...
        type: 'article',
        content:
          'Keep your cooking area away from the tents. Aim for fifty to one hundred feet. This reduces food smells near sleeping areas.',
        duration: 2,
      },
      {
        id: 'camp-4',
        ...
        type: 'article',
        content:
          'Create a clean walking path. Place food, kitchen, and personal gear in consistent spots for the whole trip. This reduces confusion and nighttime searching.',
        duration: 2,
      },
      {
        id: 'camp-5',
        ...
        type: 'article',
        content:
          'Stake out and tension your rainfly. Face the tent door away from the strongest wind. Secure loose gear before bed.',
        duration: 2,
      },
      {
        id: 'camp-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Water keeps your group healthy and moving. Leaders must know where to find it, how to treat it, and how much to carry.',
        duration: 2,
      },
      {
        id: 'water-2',
        ...
        type: 'article',
        content:
          'Look for streams, lakes, or springs. Research water points before you leave. Some dry up late in the season.',
        duration: 2,
      },
      {
        id: 'water-3',
        ...
        type: 'article',
        content:
          'Use a filter, purifier, or chemical treatment. Clear water still needs treatment. Do not skip this step.',
        duration: 2,
      },
      {
        id: 'water-4',
        ...
        type: 'article',
        content:
          'Warm days need more water. Plan one half liter per hour of hiking and more if the trail is steep or exposed.',
        duration: 2,
      },
      {
        id: 'water-5',
        ...
        type: 'article',
        content:
          'Leaders monitor how much everyone is drinking. Lightheadedness, headaches, and dark urine signal dehydration.',
        duration: 2,
      },
      {
        id: 'water-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'A trail leader sets a calm tone. Your pace, communication, and decisions shape the experience for everyone else.',
        duration: 2,
      },
      {
        id: 'lead-2',
        ...
        type: 'article',
        content:
          'Hike at the speed of your slowest member. This keeps the group unified and avoids burnout.',
        duration: 2,
      },
      {
        id: 'lead-3',
        ...
        type: 'article',
        content:
          'Leaders walk in front. A steady hiker stays in the back to make sure no one falls behind. Keep enough space for each person to move safely.',
        duration: 2,
      },
      {
        id: 'lead-4',
        ...
        type: 'article',
        content:
          'Short breaks often work better than long ones. Use them to adjust layers, drink water, and check the map.',
        duration: 2,
      },
      {
        id: 'lead-5',
        ...
        type: 'article',
        content:
          'Confidence spreads. Leaders offer steady, quiet support. No shouting. No rushing.',
        duration: 2,
      },
      {
        id: 'lead-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Long trips need simple food routines that keep energy high and packs light.',
        duration: 2,
      },
      {
        id: 'cook-2',
        ...
        type: 'article',
        content:
          'Plan meals by day. Breakfast should be fast. Lunch should require little cooking. Dinner can be warm and filling.',
        duration: 2,
      },
      {
        id: 'cook-3',
        ...
        type: 'article',
        content:
          'Different stoves burn at different rates. Estimate fuel needs based on boil times. Bring a small extra amount for cold weather.',
        duration: 2,
      },
      {
        id: 'cook-4',
        ...
        type: 'article',
        content:
          'Dehydrated meals and simple ingredients keep weight low. Heavy items add up fast on multi day trips.',
        duration: 2,
      },
      {
        id: 'cook-5',
        ...
        type: 'article',
        content:
          'Keep a small soap bottle and a scrubber. Be gentle with water sources. Scatter strained grey water away from camp.',
        duration: 2,
      },
      {
        id: 'cook-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Leaders stay aware and calm. Most risks can be managed with simple habits.',
        duration: 2,
      },
      {
        id: 'risk-2',
        ...
        type: 'article',
        content:
          'Heat, cold, water crossings, unstable rock, lightning, fatigue, and dehydration. Knowing these helps you prevent them.',
        duration: 2,
      },
      {
        id: 'risk-3',
        ...
        type: 'article',
        content:
          'Carry a small first aid kit. Know how to clean cuts, treat blisters, cool burns, and support sprains.',
        duration: 2,
      },
      {
        id: 'risk-4',
        ...
        type: 'article',
        content:
          'Turn back if someone is unwell or weather changes fast. Pride has no place in wilderness travel.',
        duration: 2,
      },
      {
        id: 'risk-5',
        ...
        type: 'article',
        content:
          'Phones, satellite messengers, and paper maps work together. Do not rely on a single tool.',
        duration: 2,
      },
      {
        id: 'risk-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Navigation builds trust. When you know where you are, your group relaxes.',
        duration: 2,
      },
      {
        id: 'nav-adv-2',
        ...
        type: 'article',
        content:
          'Lines close together mean steep terrain. Lines far apart mean gentle grades. Water flows downhill, so look at how lines bend around valleys.',
        duration: 3,
      },
      {
        id: 'nav-adv-3',
        ...
        type: 'article',
        content:
          'Know how to find north. Learn to take a bearing. Practice turning that bearing into a direction of travel.',
        duration: 3,
      },
      {
        id: 'nav-adv-4',
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Check the map often. Confirm you are passing landmarks in the right order.',
        duration: 2,
      },
      {
        id: 'nav-adv-quiz',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Wildlife is part of the outdoor experience. Leaders help everyone feel safe around it.',
        duration: 2,
      },
      {
        id: 'wild-2',
        ...
        type: 'article',
        content:
          'Use bear canisters or lockers where required. Keep scented items away from sleeping areas.',
        duration: 2,
      },
      {
        id: 'wild-3',
        ...
        type: 'article',
        content:
          'Most animals avoid people. Noise helps prevent surprising them. Leaders talk calmly and give space.',
        duration: 2,
      },
      {
        id: 'wild-4',
        ...
        type: 'article',
        content:
          'If an animal is on the trail, give it time to move. Never chase or feed wildlife.',
        duration: 2,
      },
      {
        id: 'wild-5',
        ...
        type: 'article',
        content:
          'Keep the group together at dawn and dusk. These are active times for many animals.',
        duration: 2,
      },
      {
        id: 'wild-quiz',
  ...
  // BACKCOUNTRY GUIDE (ADVANCED) MODULES
  {
    ...
    description:
      'Learn to plan complex routes using maps, satellite imagery, and local beta',
    icon: 'map',
    difficulty: 'Advanced',
    duration: '20 min',
    category: 'planning',
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Use both topographic maps and satellite imagery to evaluate terrain. Topo maps show elevation and features. Satellite imagery shows vegetation, water, recent burns, and trail visibility. Cross-check multiple sources. Look for seasonal stream flow, snow cover, and route condition reports from recent trip logs.',
        duration: 3,
      },
      {
        ...
        type: 'article',
        content:
          'Always have a Plan B. Identify alternate campsites, water sources, and exit routes before you go. Know where the nearest road, trailhead, or emergency services are. Decide in advance what conditions would trigger a change in plan—injury, weather, fatigue, or time.',
        duration: 3,
      },
      {
          ...
          questions: [
            {
              ...
              options: [
                'A Plan B with alternate routes and exits',
                'Only the main route',
              ],
              correctAnswer: 0,
            },
  ...
  },
  {
    ...
    description:
      'Understand weather systems, microclimates, and forecasting in remote areas',
    icon: 'cloud',
    difficulty: 'Advanced',
    duration: '18 min',
    category: 'planning',
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Cirrus clouds (high, wispy) can signal weather change in 24 hours. Cumulus clouds (puffy, white) are usually harmless. Cumulonimbus (towering, dark) mean thunderstorms. Lenticular clouds (lens-shaped) form near mountains and indicate strong winds aloft. Darkening skies, anvil-shaped clouds, and distant thunder are signs to seek shelter.',
        duration: 3,
      },
      {
  ...
  },
  {
    ...
    description:
      'Master compass work, terrain association, and route finding without a path',
    icon: 'navigate',
    difficulty: 'Advanced',
    duration: '22 min',
    category: 'skills',
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Cliffs, rivers, thick brush, and steep slopes will block your path. Sometimes the straight line is not the smart line. Detour around obstacles, then return to your bearing. If descending into a valley, know where the exit is before you drop in. Always have a plan for getting back out.',
        duration: 4,
      },
      {
        id: 'off-trail-night',
        ...
        type: 'article',
        content:
          'If you realize you are off course, stop. Do not keep moving. Look at your map, identify nearby features, and figure out where you are. If you cannot, backtrack to your last known point. Mark your location with cairns or flagging if legal. Navigation is a skill you build with practice—start small and increase difficulty over time.',
        duration: 4,
      },
      {
        id: 'off-trail-quiz',
        ...
        content: JSON.stringify({
          questions: [
            ...
            },
            {
              ...
              options: [
                'A natural feature used to guide your route',
                'A physical railing on a trail',
              ],
              correctAnswer: 0,
            },
          ],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Use all guylines and stake points, even if it seems calm. Wind can pick up fast. In soft ground or sand, use rocks, logs, or buried stuff sacks as anchors. In snow, bury stakes horizontally or use skis and poles. Angle stakes away from the tent at 45 degrees. A well-staked tent can handle serious wind.',
        duration: 4,
      },
      {
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Organize your camp logically: sleeping area, cooking area, and gear storage. Keep your sleeping bag dry and stored inside your tent. Store food away from camp in a bear canister or hang. Keep essentials like headlamp, water, and layers within reach. A clean, organized camp is safer and more efficient.',
        duration: 4,
      },
      {
        id: 'shelter-quiz',
          ...
          questions: [
            {
              ...
              options: [
                'Avalanche paths, rockfall zones, and low flood areas',
                'Flat, open areas',
              ],
              correctAnswer: 0,
            },
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Water is the most critical resource in the backcountry. In dry climates or during droughts, finding water requires knowledge of terrain, hydrology, and environmental clues. This module teaches you how to locate hidden water sources and use advanced purification methods to make any water safe to drink.',
        duration: 2,
      },
      {
        id: 'water-finding',
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Filters remove bacteria and protozoa but not viruses. Chemical purification (like iodine or chlorine dioxide) kills all pathogens but takes time. UV light purifiers work fast but need clear water. Boiling is the most reliable: 1 minute at sea level, 3 minutes above 6,500 feet. For murky water, pre-filter through a bandana before treating.',
        duration: 4,
      },
      {
        id: 'water-backup',
        ...
        type: 'article',
        content:
          'Carry at least two purification methods: a filter and chemical tablets. If both fail, boil water. If you cannot boil, let water sit and settle, then use the clearest layer. In an emergency, untreated water is better than severe dehydration—but treat it as soon as possible. Plan your water needs based on distance, heat, and exertion.',
        duration: 4,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Always start with the ABCs: Airway, Breathing, Circulation. Check for responsiveness. Open the airway if needed. Look for breathing and pulse. Control any severe bleeding. Then assess for spinal injury, fractures, and head trauma. Stay calm, work methodically, and prioritize life-threatening issues first.',
        duration: 4,
      },
      {
        id: 'first-aid-wounds',
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Stabilize fractures before moving the patient. Use a SAM splint, trekking poles, sticks, or foam pad. Immobilize the joints above and below the fracture. Check circulation, sensation, and movement (CSM) before and after splinting. For sprains, use RICE: Rest, Ice, Compression, Elevation. Severe fractures and dislocations require evacuation.',
        duration: 4,
      },
      {
      ...
      },
      {
        ...
        content: JSON.stringify({
          questions: [
            ...
            {
              question:
                'What should you do if someone shows signs of worsening altitude sickness?',
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'Some wilderness environments require specialized knowledge and gear. Glaciers demand rope work and crevasse awareness. Deserts test your water management and heat tolerance. Coastal zones require tide knowledge and storm awareness. This module introduces the skills and mindset needed to travel safely in extreme terrain.',
        duration: 2,
      },
      {
        id: 'extreme-glacier',
        ...
        type: 'article',
        content:
          'Never travel solo on a glacier. Use a rope team and know how to arrest a fall. Wear crampons and carry an ice axe. Probe suspicious snow bridges. Stay roped up the entire time. Learn crevasse rescue before you go. Know when to turn back—glaciers are unforgiving. Take a formal mountaineering course before attempting glaciated terrain.',
        duration: 4,
      },
      {
        id: 'extreme-desert',
  ...
  },
  {
    ...
    description:
      'Lead groups effectively, manage conflict, and maintain morale on long trips',
    icon: 'people',
    difficulty: 'Advanced',
    duration: '18 min',
    category: 'leadership',
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Before the trip, clarify who is leading, who is navigating, and what the daily routine will be. Set expectations for pace, mileage, camp tasks, and decision-making. Make sure everyone knows the plan and agrees to it. Clear roles prevent confusion and resentment. Revisit expectations if things change.',
        duration: 4,
      },
      {
        ...
        type: 'article',
        content:
          'Check in with your group daily—physically and emotionally. Ask how people are feeling. Address small issues before they become big ones. Use active listening. Avoid assumptions. If someone is struggling, give them space to speak up. Create a culture where it is okay to say you are tired, scared, or unsure.',
        duration: 4,
      },
      {
    ...
    steps: [
      {
        ...
        type: 'article',
        content:
          'In the wilderness, decisions have consequences. Push through a storm or camp early? Cross a river or find another route? Continue when someone is hurt or call for help? This module teaches structured decision-making frameworks, risk assessment, and how to avoid common cognitive traps that lead to accidents.',
        duration: 2,
      },
      {
        id: 'decision-risk',
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Summit fever, sunk cost fallacy, and groupthink cause bad decisions. Just because you have come this far does not mean you must continue. Just because everyone else is okay with the plan does not mean it is safe. Check your ego. Encourage dissent. Build a culture where it is okay to speak up and turn back.',
        duration: 4,
      },
      {
        ...
        type: 'article',
        content:
          'One framework: Stop, Think, Observe, Plan (STOP). Stop moving. Think about the situation. Observe your surroundings and conditions. Plan your next step. Another: Define the problem, list options, evaluate consequences, choose, act, review. Use a structured process when emotions or fatigue cloud judgment.',
        duration: 4,
      },
      {
        ...
        type: 'article',
        content:
          'Once you make a decision, commit to it fully—but stay flexible. Conditions change. New information emerges. Be willing to reverse course. Ego should not prevent you from changing your mind. Good leaders adapt. Poor leaders double down on bad plans. Your goal is to bring everyone home safely.',
        duration: 4,
      },
      {
        id: 'decision-quiz',
  ...
  },
  {
    ...
    description:
      'Understand SAR protocols, self-rescue techniques, and how to assist responders',
    ...
    steps: [
      ...
      },
      {
        ...
        type: 'article',
        content:
          'Most SAR calls are preventable. File a trip plan. Carry the 10 Essentials. Stay on trail. Turn back when conditions worsen. Bring a communication device: satellite messenger, PLB, or cell phone. The best way to avoid needing SAR is to prepare well and make smart decisions in the field.',
        duration: 4,
      },
      {
        id: 'sar-calling',
      ...
      completeStep: (moduleId, stepId) => {
        set((state) => {
          ...
          const allStepsCompleted =
            module?.steps.every(
              (step) => updatedSteps[step.id]?.status === 'completed',
            ) || false;
