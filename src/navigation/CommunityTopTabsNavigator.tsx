...
const getHeroContent = (routeName: string) => {
  switch (routeName) {
    case 'Tips':
      return {
        title: 'Community',
        description: 'Discover expert advice and helpful camping tips',
      };
    case 'Gear':
      return {
        title: 'Community',
        description: 'Read and share honest gear reviews from fellow campers',
      };
    case 'Ask':
    ...
    case 'Photos':
      return {
        title: 'Community',
        description: 'Share and explore beautiful camping moments',
      };
    case 'Feedback':
    ...
    default:
      return {
        title: 'Community',
        description: 'Share tips, gear reviews, and connect with fellow campers',
      };
  }
};
...
export default function CommunityTopTabsNavigator({
  initialRouteName,
}: CommunityTopTabsNavigatorProps = {}) {
