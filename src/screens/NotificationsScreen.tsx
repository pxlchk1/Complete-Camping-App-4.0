    ...
    return (
      <View key={sectionKey} className="mt-4">
        ...
        {isExpanded && (
          ...
          >
            {items.map((item) =>
              renderPreferenceRow(item.key, item.label, item.description),
            )}
          </View>
        )}
      </View>
        ...
        <View className="px-5 pt-5">
          ...
          {permissionStatus === 'denied' && (
            <View
              ...
              style={{ backgroundColor: '#FFF3E0', borderColor: RUST_ORANGE }}
            >
              <View className="flex-row items-center">
                <Ionicons
                  name="warning"
              ...
              <Text
                ...
                style={{ fontFamily: 'SourceSans3_400Regular', color: TEXT_SECONDARY }}
              >
                To receive notifications, please enable them in your device's Settings
                app.
              </Text>
            </View>
          )}
          ...
          {preferences.enabled && (
            <>
              ...
              {renderSection('trips', 'Trips & Planning', 'calendar-outline', [
                {
                  ...
                  description: 'Notifications 3 days and 1 day before your trip',
                },
                {
                  key: 'leaveTimeReminders',
                  label: 'Leave Time Reminders',
                  description: 'When to leave based on drive time',
                },
                {
                  key: 'arrivalDayNudge',
                  label: 'Arrival Day',
                  description: '"You\'re arriving today!" notification',
                },
                {
                  key: 'tripEndingReminder',
                  label: 'Trip Ending',
                  description: 'Reminder that your trip is ending',
                },
                {
                  key: 'postTripRecap',
                  label: 'Post-Trip Recap',
                  description: 'Reminder to add photos and notes',
                },
              ])}
              ...
              {renderSection('packing', 'Packing List', 'cube-outline', [
                {
                  key: 'packingListReminders',
                  label: 'Packing Reminders',
                  description: 'Remind to pack before your trip',
                },
                {
                  key: 'essentialsMissing',
                  label: 'Essentials Missing',
                  description: 'Alert when key categories are empty',
                },
                {
                  key: 'sharedPackingUpdates',
                  label: 'Shared List Updates',
                  description: 'When someone updates a shared list',
                },
                {
                  key: 'restockReminders',
                  label: 'Restock Reminders',
                  description: 'Consumables to restock after trip',
                },
              ])}
              ...
              {renderSection('weather', 'Weather & Safety', 'cloud-outline', [
                {
                  ...
                  description: 'Rain, wind, and extreme temperatures',
                },
                {
                  key: 'severeWeatherWarnings',
                  label: 'Severe Weather',
                  description: 'Storms, tornado, lightning warnings',
                },
                {
                  key: 'freezeWarnings',
                  label: 'Freeze Warnings',
                  description: 'When overnight lows are freezing',
                },
                {
                  key: 'fireWeatherAlerts',
                  label: 'Fire Weather',
                  description: 'Burn bans and fire danger',
                },
                {
                  key: 'airQualityAlerts',
                  label: 'Air Quality',
                  description: 'Smoke and poor air quality',
                },
              ])}
              ...
              {renderSection('parks', 'Parks & Discovery', 'leaf-outline', [
                {
                  key: 'parkAdvisories',
                  label: 'Park Advisories',
                  description: 'Closures for your favorite parks',
                },
                {
                ...
                {
                  key: 'nearbyParkSuggestions',
                  label: 'Nearby Parks',
                  description: 'Location-based park suggestions',
                },
              ])}
              ...
              {renderSection('community', 'Community', 'people-outline', [
                ...
                {
                  key: 'tipEngagement',
                  label: 'Tip Engagement',
                  description: 'When your tip is featured or upvoted',
                },
                {
                  key: 'moderatorMessages',
                  label: 'Moderator Messages',
                  description: 'Important system messages',
                },
                {
                  key: 'campgroundInvites',
                  label: 'Campground Invites',
                  description: 'My Campground connection requests',
                },
              ])}
              ...
              {renderSection('account', 'Account', 'person-outline', [
                {
                  ...
                  description: 'When your trial is ending',
                },
                {
                  key: 'subscriptionReminders',
                  label: 'Subscription Reminders',
                  description: 'Renewal notifications',
                },
                {
                  key: 'paymentIssues',
              ...
              {renderSection('learning', 'Learning', 'school-outline', [
                {
                  ...
                  description: 'Unlocked and completed modules',
                },
                {
                  key: 'badgeEarned',
                  label: 'Badges Earned',
                  description: 'New badge notifications',
                },
              ])}
              ...
              {renderSection('operational', 'Operational', 'settings-outline', [
                {
                  key: 'permissionReminders',
                  label: 'Permission Reminders',
                  description: 'When location or notifications are off',
                },
              ])}
            </>
          )}
