...
import { doc, getDoc, getDocFromServer, setDoc, collection, query, where, getDocs, serverTimestamp, orderBy, limit } from "firebase/firestore";
...
export default function MyCampsiteScreen({ navigation }: any) {
  ...
  const loadProfile = useCallback(async (userId: string) => {
    try {
      ...
      // Force server read to bypass stale cache from App.tsx safety-net race
      let profileSnap;
      try {
