...
export default function MyCampsiteScreen({ navigation }: any) {
  ...
  const { showModal, currentTooltip, dismissModal, openModal } =
    useScreenOnboarding('MyCampsite');
      ...
      try {
        ...
        questionsSnap1.forEach((doc) => {
          ...
          contributions.push({
            ...
            type: 'question',
            title:
              data.title || data.question || data.body?.substring(0, 50) || 'Question',
            createdAt: data.createdAt,
          });
        });
      } catch (e) {
    ...
    return (
      ...
      >
        <View className="items-center px-6">
          ...
          >
            Create an account to save your favorite parks, track trips, and build your
            camping profile.
          </Text>
        </View>
  ...
  const isProfileContentVisible =
    !shouldHidePrivateContent || profile.isProfileContentPublic !== false;
    ...
    <View className="flex-1" style={{ backgroundColor: PARCHMENT }}>
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View style={{ height: COVER_HEIGHT + insets.top }}>
          <ImageBackground
            source={
              profile.backgroundUrl ? { uri: profile.backgroundUrl } : HERO_IMAGES.WELCOME
            }
            ...
            >
              ...
              <View className="items-center mt-3">
                ...
                <View
                  ...
                  style={{
                    backgroundColor: getMembershipBadgeColor(profile.membershipTier),
                  }}
                >
                  <Text
                    className="text-xs"
        ...
        <View className="px-5" style={{ marginTop: 16 }}>
              ...
              <View className="flex-row gap-2">
                ...
                {profile.meritBadges && profile.meritBadges.length > 0 ? (
                  profile.meritBadges.map((badge) => (
                    <View key={badge.id} className="items-center" style={{ width: 70 }}>
                      <View
                        style={{
                          width: 56,
                          height: 56,
          ...
          {/* Social Stats Row */}
          <View
            className="flex-row mb-4 py-3 border-y"
              ...
              <View className="mb-2">
                ...
                <View className="ml-7">
                  {Object.entries(profile.favoriteGear)
                    .filter(
                      ([category]) =>
                        isNaN(Number(category)) && category.trim().length > 0,
                    )
            ...
            >
              {(['photos', 'connect'] as ActivityTab[]).map((tab) => (
                <Pressable
                  ...
                  style={{
                    backgroundColor:
                      activeTab === tab ? DEEP_FOREST : CARD_BACKGROUND_LIGHT,
                  }}
                >
                  <Text
                    style={{
                ...
                >
                  {connectContributions.map((contribution, index) => (
                    <Pressable
                      ...
                      onPress={() => {
                        ...
                        if (contribution.type === 'question') {
                          navigation.navigate('QuestionDetail', {
                            questionId: contribution.id,
                          });
                        } else if (contribution.type === 'review') {
                          navigation.navigate('GearReviewDetail', {
                            reviewId: contribution.id,
                          });
                      ...
                      style={{
                        borderBottomWidth:
                          index < connectContributions.length - 1 ? 1 : 0,
                    ...
                    <View className="flex-row items-start justify-between">
                      <View className="flex-1 mr-3">
                        ...
                        <View className="flex-row items-center">
                          ...
                          {fav.state && (
                            <>
                              <Text className="mx-1" style={{ color: TEXT_SECONDARY }}>
                                •
                              </Text>
                              <Text
                                className="text-sm"
        ...
        >
          ...
          >
            ...
            <View style={{ padding: 20 }}>
              ...
              >
                Earn merit badges by camping, sharing tips, reviewing gear, and helping
                fellow campers. The more you contribute, the more badges you unlock!
              </Text>
