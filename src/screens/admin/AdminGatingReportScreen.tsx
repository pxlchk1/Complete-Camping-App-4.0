...
export default function AdminGatingReportScreen() {
  ...
  const handleExport = async () => {
    try {
      ...
      Alert.alert(
        'Exported!',
        'Gating registry copied to clipboard and printed to console.',
      );
    } catch (error) {
    ...
    >
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 100 }}>
            ...
            >
              <Text
                style={{
                  fontFamily: 'Raleway_700Bold',
                  fontSize: 24,
                  color: LEVEL_COLORS.account_required.text,
                }}
              >
            ...
            >
              <Text
                style={{
                  fontFamily: 'Raleway_700Bold',
                  fontSize: 24,
                  color: LEVEL_COLORS.pro_required.text,
                }}
              >
                {summary.proRequired}
              </Text>
            ...
            >
              <Text
                style={{
                  fontFamily: 'Raleway_700Bold',
                  fontSize: 24,
                  color: LEVEL_COLORS.free_limit.text,
                }}
              >
                {summary.freeLimits}
              </Text>
        ...
        <View className="px-4 pb-3">
          ...
          >
            <Pressable
              ...
              style={{
                backgroundColor: filter === 'all' ? DEEP_FOREST : 'white',
                borderWidth: 1,
                borderColor: BORDER_SOFT,
              }}
            >
              ...
              style={{
                backgroundColor:
                  filter === 'account_required'
                    ? LEVEL_COLORS.account_required.text
                    : LEVEL_COLORS.account_required.bg,
              }}
            >
              <Text
                style={{
            ...
            <Pressable
              ...
              style={{
                backgroundColor:
                  filter === 'pro_required'
                    ? LEVEL_COLORS.pro_required.text
                    : LEVEL_COLORS.pro_required.bg,
              }}
            >
              <Text
                style={{
                  ...
                  fontSize: 13,
                  color:
                    filter === 'pro_required' ? 'white' : LEVEL_COLORS.pro_required.text,
                }}
              >
            ...
            <Pressable
              ...
              style={{
                backgroundColor:
                  filter === 'free_limit'
                    ? LEVEL_COLORS.free_limit.text
                    : LEVEL_COLORS.free_limit.bg,
              }}
            >
              <Text
                style={{
        ...
        <View className="px-4">
          ...
          {(filter === 'all' || filter === 'account_required') &&
            groupedGates.account_required.length > 0 && (
              <View className="mb-4">
          ...
          {/* Free Limit Section */}
          {(filter === 'all' || filter === 'free_limit') &&
            groupedGates.free_limit.length > 0 && (
              <View className="mb-4">
                <View className="flex-row items-center mb-2">
                  <View
                    className="w-3 h-3 rounded-full mr-2"
          ...
          {(filter === 'all' || filter === 'pro_required') &&
            groupedGates.pro_required.length > 0 && (
              <View className="mb-4">
                <View className="flex-row items-center mb-2">
                  <View
                    className="w-3 h-3 rounded-full mr-2"
