        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (result.success) {
              ...
              Alert.alert('Error', result.error?.message || 'Failed to delete review');
            }
          },
        },
      ],
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            if (result.success) {
              ...
              Alert.alert('Error', result.error?.message || 'Failed to remove review');
            }
          },
        },
      ],
    ...
    <View className="flex-1 bg-parchment">
      ...
      <ScrollView className="flex-1 p-5">
            ...
            onPress={() => {
              if (review.productUrl) {
                ...
                Linking.openURL(urlToOpen).catch((err) => {
                  ...
                  Alert.alert(
                    'Error',
                    'Could not open link. Please check the URL is valid.',
                  );
                });
              }
            }}
        ...
        <View
          ...
          style={{ borderColor: BORDER_SOFT, marginBottom: 24 }}
        >
          {review.authorId && review.authorHandle ? (
            <Pressable
              onPress={() =>
                navigation.navigate('MyCampsite', { userId: review.authorId })
              }
            >
              <Text
                className="text-sm"
