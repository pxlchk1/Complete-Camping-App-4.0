...
export default function TipDetailScreen() {
  ...
  const handleReport = () => {
    ...
    Alert.alert('Report tip', 'Why are you reporting this tip?', [
      { text: 'Cancel', style: 'cancel' },
      {
        text: 'Report',
        style: 'destructive',
    ...
    <View className="flex-1 bg-parchment">
      ...
      >
          ...
          <View className="p-5">
            ...
            >
              ...
              <VotePill
                ...
                itemId={tipId}
                initialScore={
                  tip.score || (tip.upvoteCount || 0) - (tip.downvoteCount || 0)
                }
              ...
              comments.map((comment) => (
                ...
                >
                  ...
                  <Text
                    ...
                    style={{ fontFamily: 'SourceSans3_400Regular', color: TEXT_MUTED }}
                  >
                    by @{(comment as any).username || 'Anonymous'} •{' '}
        ...
        <View
          ...
          style={{ borderColor: BORDER_SOFT, backgroundColor: PARCHMENT }}
        >
