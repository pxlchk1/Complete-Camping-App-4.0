        ...
        <View className="p-3">
          ...
          <View className="flex-row items-center mb-2">
            ...
            {item.authorId && item.authorHandle ? (
              ...
              <Pressable
                onPress={() =>
                  navigation.navigate('MyCampsite', { userId: item.authorId })
                }
              >
                <Text
                  className="text-xs"
          ...
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center">
              <Pressable onPress={() => onVote(item.id, 'up')} className="mr-2">
                <Ionicons
              ...
              <Pressable onPress={() => onVote(item.id, 'down')} className="ml-2">
                <Ionicons
    ...
    <View className="flex-1 bg-cream-50">
      ...
      <View className="bg-forest" style={{ paddingVertical: 12 }}>
        ...
        >
          ...
          <Pressable onPress={handleUploadPhoto} className="active:opacity-70">
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <Text
                  className={
                    selectedCategory === item.id ? 'text-parchment' : 'text-forest-800'
                  }
                  style={{
                    fontFamily:
                      selectedCategory === item.id
      ...
      {!user ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => <PhotoCard item={item} onVote={handleVote} />}
        />
      )}
