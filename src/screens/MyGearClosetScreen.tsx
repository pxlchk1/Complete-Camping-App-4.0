...
export default function MyGearClosetScreen() {
  ...
  const { showModal, currentTooltip, dismissModal, openModal } =
    useScreenOnboarding('GearCloset');
      ...
      <View className="flex-1" style={{ backgroundColor: PARCHMENT }}>
        ...
        <View className="flex-1 items-center justify-center px-5">
          ...
          <Text
            ...
            style={{ fontFamily: 'SourceSans3_400Regular', color: TEXT_SECONDARY }}
          >
            Create an account to track your camping gear, add photos, and organize your
            equipment.
          </Text>
          <Pressable
      ...
      >
        ...
        >
          <Pressable
            ...
            style={{
              backgroundColor:
                activeFilter === 'all' ? DEEP_FOREST : CARD_BACKGROUND_LIGHT,
            }}
          >
            <Text
              style={{
          ...
          {GEAR_CATEGORIES.map((category) => (
            <Pressable
              ...
              style={{
                backgroundColor:
                  activeFilter === category.value ? DEEP_FOREST : CARD_BACKGROUND_LIGHT,
              }}
            >
              <Text
                style={{
                  ...
                  fontSize: 14,
                  color:
                    activeFilter === category.value ? PARCHMENT : TEXT_PRIMARY_STRONG,
                }}
              >
                {category.label}
              </Text>
