            ...
            <View key={track.id} className="mb-6">
              ...
              >
                <View className="flex-row items-center justify-between mb-3">
                  <Heading3 color={TEXT_PRIMARY_STRONG}>Track progress</Heading3>
                  <View className="bg-sierraSky/20 rounded-full px-3 py-1 border border-sierraSky">
                    <Text
                      className="text-riverRock font-medium"
                      style={{ fontFamily: 'SourceSans3_600SemiBold' }}
                    >
                      {currentTrackProgress.completed}/{currentTrackProgress.total}{' '}
                      Complete
                    </Text>
                  </View>
                </View>
                ...
                >
                  {currentTrackProgress.xpEarned}/{currentTrackProgress.xpTotal} XP earned
                  in this track
                </Text>
              </View>
            </View>
                ...
                <View className="flex-row items-start">
                  ...
                  <View className="flex-1">
                    ...
                    <View className="flex-row items-center flex-wrap">
                      <View
                        className={`rounded-full px-2 py-1 ${getDifficultyColor(module.difficulty)}`}
                      >
                        <Text
