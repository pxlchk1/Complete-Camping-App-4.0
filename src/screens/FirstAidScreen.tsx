...
const FIRST_AID_CATEGORIES = [
  ...
  {
    id: 'sprains',
    title: 'Sprains, Strains, Fractures, and Joint Injuries',
    icon: 'fitness',
  },
    ...
    <View className="flex-1" style={{ backgroundColor: PARCHMENT_BACKGROUND }}>
      ...
      <View style={{ height: 200 + insets.top }}>
        ...
        >
          ...
          <View
            className="flex-1"
            style={{ paddingTop: insets.top, transform: [{ scaleX: -1 }] }}
          >
      ...
      >
          ...
          <View className="bg-red-50 rounded-xl p-4 border-2 border-red-300 mb-6">
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                <Text
                  className="text-red-800 text-lg mb-2"
                ...
                >
                  For serious injuries or medical emergencies, always call emergency
        ...
        <View className="px-5 mb-8">
          <Text
            className="text-2xl text-forest-800 mb-4"
          ...
          <View className="space-y-2">
            {FIRST_AID_CATEGORIES.map((category, index) => (
              ...
              >
                ...
                <Text
                  className="flex-1 text-forest-800 text-base"
        ...
        >
          <Text
            className="text-2xl text-forest-800 mb-1"
            style={{ fontFamily: 'Raleway_700Bold' }}
          >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            <Text
              className="text-xl text-forest-800 mb-3"
              style={{ fontFamily: 'SourceSans3_700Bold' }}
            >
              1. Burns (All Degrees)
            </Text>
            ...
            <Text
              className="text-forest-800 text-base mb-2"
              style={{ fontFamily: 'SourceSans3_600SemiBold' }}
            >
            ...
            <Text
              className="text-stone-700 mb-4"
              style={{ fontFamily: 'SourceSans3_400Regular' }}
            >
              • White, black, brown, or charred skin{'\n'}• Leathery texture{'\n'}•
              Swelling{'\n'}• Possible numbness{'\n'}• Trouble breathing if smoke is
              involved
            </Text>
            ...
            <View className="bg-green-50 rounded-lg p-4 border border-green-200 mb-3">
              ...
              >
                ...
                {'\n'}• Cover with sterile nonstick dressing{'\n'}• Seek care if burn is
                large or on face, hands, feet, groin, buttocks, or major joints
              </Text>
            </View>
            ...
            <View className="bg-green-50 rounded-lg p-4 border border-green-200 mb-3">
              ...
              >
                ...
                not apply water to large severe burns{'\n'}• Cover loosely with sterile
                dressing{'\n'}• Keep person warm
              </Text>
            </View>
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/heat-exhaustion/diagnosis-treatment/drc-20373255',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/heat-stroke/diagnosis-treatment/drc-20353588',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
        ...
        >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/hypothermia/diagnosis-treatment/drc-20352624',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
        ...
        >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/first-aid/first-aid-cuts-and-scrapes/basics/art-20056711',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/first-aid/first-aid-bites-and-stings/basics/art-20056593',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl('https://www.cdc.gov/ticks/removing-a-tick/index.html')
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
              <Ionicons name="open-outline" size={16} color="#2563eb" />
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/first-aid/first-aid-wounds/basics/art-20056711',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/first-aid/first-aid-bleeding/basics/art-20056661',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
        ...
        >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/sprains-and-strains/diagnosis-treatment/drc-20377945',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/dislocation/diagnosis-treatment/drc-20371726',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
        ...
        >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/hives/diagnosis-treatment/drc-20354904',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
          ...
          <View className="bg-parchment rounded-xl p-5 border border-cream-200 mb-4">
            ...
            <Pressable
              onPress={() =>
                openUrl(
                  'https://www.mayoclinic.org/diseases-conditions/anaphylaxis/diagnosis-treatment/drc-20351483',
                )
              }
              className="flex-row items-center mt-2 active:opacity-70"
            >
