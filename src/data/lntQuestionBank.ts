...
export const LNT_QUESTION_BANK: LNTQuestion[] = [
  ...
  },
  {
    ...
    type: 'scenario',
    difficulty: 2,
    prompt: 'You see a shortcut cutting down a switchback. Why is taking it a problem?',
    choices: [
  ...
  },
  {
    ...
    correctChoiceIds: ['f'],
    explanation: 'Trampling damage can last months or years, even from one night.',
    tags: ['camping'],
    shuffleChoices: false,
    isActive: true,
  },
  {
    ...
    correctChoiceIds: ['a'],
    explanation: 'Concentrating use in established sites prevents creating new damage.',
    tags: ['popular_area'],
    shuffleChoices: true,
    isActive: true,
  },
  {
    ...
    type: 'single',
    difficulty: 3,
    prompt: 'In a pristine area with no established trails, what is the best approach?',
    choices: [
      {
        id: 'a',
    ...
    correctChoiceIds: ['a'],
    explanation: 'Spreading out reduces the chance of creating a permanent social trail.',
    tags: ['backcountry'],
    shuffleChoices: true,
    isActive: true,
  },
  ...
  // ===== PRINCIPLE 4: Leave What You Find =====
  {
    ...
    type: 'single',
    difficulty: 1,
    prompt: 'Why should you leave rocks, plants, and artifacts where you find them?',
    choices: [
      {
        id: 'a',
  ...
  },
  {
    ...
    correctChoiceIds: ['b'],
    explanation: 'These items are protected and belong in place, not in a backpack.',
    tags: ['history'],
    shuffleChoices: true,
    isActive: true,
  },
  {
    ...
    correctChoiceIds: ['b'],
    explanation: 'It wounds the tree and encourages more people to do the same.',
    tags: ['damage'],
    shuffleChoices: true,
    isActive: true,
  },
  {
    ...
    type: 'single',
    difficulty: 2,
    prompt: 'Is it okay to build camp furniture from logs if you put it back later?',
    choices: [
  ...
  },
  {
    ...
    correctChoiceIds: ['a'],
    explanation: 'Using existing rings prevents new scars and keeps impact contained.',
    tags: ['site'],
    shuffleChoices: true,
    isActive: true,
  },
  ...
  },
  {
    ...
    correctChoiceIds: ['b'],
    explanation: 'Parents are often nearby. Human contact can put the animal at risk.',
    tags: ['ethics'],
    shuffleChoices: true,
    isActive: true,
  },
  {
    ...
    correctChoiceIds: ['b'],
    explanation: "If you change an animal's behavior, you are already affecting it.",
    tags: ['respect'],
    shuffleChoices: true,
    isActive: true,
  },
  ...
  },
  {
    ...
    correctChoiceIds: ['b'],
    explanation: 'Even low music can travel far, especially across water or open areas.',
    tags: ['noise'],
    shuffleChoices: true,
    isActive: true,
  },
  {
    ...
    type: 'single',
    difficulty: 2,
    prompt: 'On a narrow trail, what is a good etiquette move when others are passing?',
    choices: [
    ...
    correctChoiceIds: ['b'],
    explanation: 'Yielding politely reduces trail widening and keeps everyone safer.',
  ...
  },
  {
    ...
    type: 'tf',
    difficulty: 2,
    prompt: 'Bright lanterns at night are fine as long as you stay at your site.',
    choices: [
      { id: 't', text: 'True' },
      { id: 'f', text: 'False' },
    ],
  ...
  },
  {
    ...
    type: 'scenario',
    difficulty: 3,
    prompt: 'Another group is being loud late at night. What is a good first step?',
    choices: [
