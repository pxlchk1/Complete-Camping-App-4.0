...
const winterBackpacking: TemplateDefinition = {
  ...
  items: [
    // Shelter
    item('4-season tent', 'shelter', true, {
      gearGroup: 'shelterPrimary',
      variant: '4season',
      gearClosetEligible: true,
    }),
    ...
    // Sleep
    item('Sleeping bag (0–20°F)', 'sleep', true, {
      gearGroup: 'sleepPrimary',
      variant: 'cold',
      gearClosetEligible: true,
    }),
    item('Sleeping pad (R4+ insulated)', 'sleep', true, {
      gearGroup: 'padPrimary',
      variant: 'insulated',
      gearClosetEligible: true,
    }),
    ...
    // Water
    item('Water bottles or bladder', 'water', true, {
      quantity: 2,
      gearClosetEligible: true,
    }),
    ...
    // Layers & Warmth
    item('Insulating jacket (down or synthetic)', 'layers_warmth', true, {
      gearClosetEligible: true,
    }),
    ...
    item('Bear hang kit or canister', 'navigation_safety', true, {
      notes: 'Region dependent',
    }),
...
const summerBackpacking: TemplateDefinition = {
  ...
  items: [
    // Shelter
    item('3-season tent', 'shelter', true, {
      gearGroup: 'shelterPrimary',
      variant: '3season',
      gearClosetEligible: true,
    }),
    ...
    // Sleep
    item('Sleeping bag (30–50°F)', 'sleep', true, {
      gearGroup: 'sleepPrimary',
      variant: 'warm',
      gearClosetEligible: true,
    }),
    item('Sleeping pad', 'sleep', true, {
      gearGroup: 'padPrimary',
      variant: 'standard',
      gearClosetEligible: true,
    }),
...
const summerCarCamping: TemplateDefinition = {
  ...
  items: [
    ...
    // Navigation & Safety
    item('Headlamp / flashlight', 'navigation_safety', true, {
      gearClosetEligible: true,
    }),
...
const fallCarCamping: TemplateDefinition = {
  ...
  items: [
    ...
    // Sleep
    item('Sleeping bag (20–40°F)', 'sleep', true, {
      gearGroup: 'sleepPrimary',
      variant: 'mid',
      gearClosetEligible: true,
    }),
...
const winterCarCamping: TemplateDefinition = {
  ...
  items: [
    // Shelter
    item('Winter-rated tent or hot tent', 'shelter', true, {
      gearGroup: 'shelterPrimary',
      variant: '4season',
      gearClosetEligible: true,
    }),
    ...
    item('Insulated sleeping pad', 'sleep', true, {
      gearGroup: 'padPrimary',
      variant: 'insulated',
      gearClosetEligible: true,
    }),
    ...
    item('Cooler (for keeping things from freezing)', 'kitchen', false, {
      gearClosetEligible: true,
    }),
...
const threeSeasonHammock: TemplateDefinition = {
  ...
  items: [
    ...
    item('Bug net', 'shelter', true, {
      notes: 'If not integrated',
      gearClosetEligible: true,
    }),
    item('Ridgeline organizer', 'shelter', false),

    // Sleep
    item('Top quilt or sleeping bag', 'sleep', true, {
      gearGroup: 'sleepPrimary',
      variant: 'mid',
      gearClosetEligible: true,
    }),
...
const winterHammock: TemplateDefinition = {
  ...
  items: [
    ...
    // Sleep
    item('Top quilt (0–20°F)', 'sleep', true, {
      gearGroup: 'sleepPrimary',
      variant: 'cold',
      gearClosetEligible: true,
    }),
...
const dispersedCamping: TemplateDefinition = {
  ...
  items: [
    ...
    item('Water containers', 'water', true, {
      quantity: 2,
      notes: 'Extra capacity essential',
    }),
    ...
    item('Satellite messenger', 'navigation_safety', false, {
      notes: 'InReach, SPOT, etc.',
    }),
