...
export async function seedFeedbackData() {
  ...
  try {
    ...
    console.log(
      `   - Feature Requests: ${SEED_FEEDBACK.filter((f) => f.category === 'feature').length}`,
    );
    console.log(
      `   - Bug Reports: ${SEED_FEEDBACK.filter((f) => f.category === 'bug').length}`,
    );
    console.log(
      `   - Improvements: ${SEED_FEEDBACK.filter((f) => f.category === 'improvement').length}`,
    );
    console.log(
      `   - Questions: ${SEED_FEEDBACK.filter((f) => f.category === 'question').length}`,
    );
    console.log(
      `   - Other: ${SEED_FEEDBACK.filter((f) => f.category === 'other').length}`,
    );
  } catch (error) {
