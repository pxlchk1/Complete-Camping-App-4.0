...
const SEED_TIPS = [
  {
    ...
    content:
      'Never rely on just one method to start a fire. Pack waterproof matches, a lighter, and a ferrocerium rod. Store them in separate waterproof containers. I learned this the hard way when my lighter failed in wet conditions.',
    category: 'Safety',
  ...
  },
  {
    ...
    content:
      'Pack 3 base layers, 3 insulating layers, and 3 outer shell options. This gives you flexibility for changing weather without overpacking. Merino wool base layers are worth the investment - they regulate temperature and resist odors.',
    category: 'Gear',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
  ...
  },
  {
    ...
    content:
      'Set up your tent in the backyard before your trip. Cook a meal on your camp stove. Make sure everything works and you know how to use it. There is nothing worse than figuring out a broken zipper or missing pole at the campsite.',
    category: 'Setup',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
  ...
  },
  {
    ...
    content:
      'Use the PCT method: throw rope over a branch 15+ feet high and 6+ feet from the trunk. Hang food at least 12 feet off the ground and 6 feet from the tree. This takes practice - do not wait until dark to figure it out.',
    category: 'Wildlife',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
  ...
  },
  {
    ...
    content:
      'The rule of thumb is 2 liters per person per day, but bring 3-4 liters if you are hiking in hot weather or at altitude. Dehydration ruins trips. Know where water sources are on your route and always carry purification tablets or a filter.',
    category: 'Water',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
  ...
  },
  {
    ...
    content:
      'Use small stuff sacks or ziplock bags to organize gear by category: cooking, first aid, hygiene, electronics, repair kit. Label them with bright tape. You will find things faster and nothing gets lost at the bottom of your pack.',
    category: 'Setup',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
  ...
  },
  {
    ...
    content:
      'Prep meals at home when possible. Pre-mix dry ingredients, pre-chop vegetables, pre-cook rice. At camp, set up a washing station away from your cooking area. Always have a mesh bag for drying dishes overnight.',
    category: 'Cooking',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
  ...
  },
  {
    ...
    content:
      'This is the most useful camping knot. It creates a fixed loop that will not slip or bind. Use it for bear bags, hanging tarps, securing gear, tying boats. Practice until you can tie it in the dark with gloves on.',
    category: 'Setup',
    authorId: SEED_USER.id,
    authorHandle: SEED_USER.handle,
    authorName: SEED_USER.name,
...
const SEED_QUESTIONS = [
  {
    ...
    content:
      'I am planning my first camping trip in July in the Pacific Northwest. Daytime temps will be 70-80F. What temperature rating should I look for in a sleeping bag? Is 40F enough or should I go warmer?',
  ...
  },
  {
    ...
    content:
      'Going car camping for 4 days and need to keep perishables cold. I have a standard cooler. What is the best ice-to-food ratio? Should I use block ice or cubed ice? Any other tips for maximizing cold retention?',
  ...
  },
  {
    ...
    content:
      'Got caught in a rainstorm yesterday and everything is soaked - tent, clothes, sleeping bag. What is the best strategy for drying gear at camp when you still have 2 nights left? Should I try to pack wet gear or keep trying to dry it?',
  ...
  },
  {
    ...
    content:
      'I really want to go camping but none of my friends are interested. Is it safe for a beginner to camp solo? What extra precautions should I take? Should I start with car camping or is backcountry okay?',
...
const SEED_FEEDBACK = [
  {
    ...
    description:
      'It would be great if I could plan trips and add items to packing lists without internet connection. Many camping areas have no cell service, and I often plan during my commute on the subway.',
  ...
  },
  {
    ...
    description:
      'Would love to be able to export my packing lists as PDFs so I can print them out. Not everyone wants to use their phone at camp.',
    category: 'feature_request',
    status: 'under_review',
    authorId: SEED_USER.id,
  ...
  },
  {
    ...
    description:
      'The weather forecast showed sunny for my trip but it rained the whole time. Maybe add a way to compare multiple weather sources or show the confidence level?',
  ...
  },
  {
    ...
    description:
      'For backpackers, it would be awesome to track the weight of each item in the packing list and see a total pack weight. This would help with planning and knowing if I am over-packing.',
    category: 'feature_request',
    status: 'planned',
    authorId: SEED_USER.id,
