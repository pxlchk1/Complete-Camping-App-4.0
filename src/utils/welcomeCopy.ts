...
const CAMPING_TYPE_MESSAGES: Record<string, string> = {
  ...
  'trailer camping (travel trailer)':
    'Your trailer is ready for the next home-base weekend.',
  ...
  'vintage camper camping':
    'Your vintage camper is ready for the next sweet little road trip.',
...
export function getWelcomeSubtext(
  favoriteCampingType?: string | null,
  isLoggedIn?: boolean,
): string {
  if (!isLoggedIn) {
