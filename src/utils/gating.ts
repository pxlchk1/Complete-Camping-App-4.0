...
export const ACCOUNT_PROMPT_MESSAGE =
  'You need to have an account or be logged in to do that.';
...
export function requireAccount(
  callbacks: Pick<AccessGateCallbacks, 'showAccountPrompt' | 'openAccountModal'>,
): boolean {
  if (!auth.currentUser) {
